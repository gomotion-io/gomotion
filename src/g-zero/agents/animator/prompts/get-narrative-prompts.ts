...
4. **Design Visuals**: Use animations, text overlays and text effects like gsap split text, images from **pexels-mcp-server_searchPhotos**, and effects to enhance the narrative. Ensure visuals support the story emotionally and thematically.
5. **Refine and Output**: Ensure the images is polished, follows all base instructions, and outputs as the specified JSON format. Test for coherence and engagement.
...
- If you need images, you may use the **pexels-mcp-server_searchPhotos** tool to get image URLs. Do not include any tool call transcripts or explanations in the final answer. The final answer MUST be a single JSON object only.
