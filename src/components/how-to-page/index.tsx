    ...
    <div className="max-w-[85rem] mx-auto pt-5 px-5 lg:px-44">
      ...
      <section className="reveal flex flex-col gap-6 pt-24 max-w-3xl">
        ...
        <p className="text-xl leading-relaxed">
          ...
          and click on the <strong>&quot;Sign In&quot;</strong> button in the
          top right corner.
        </p>

        <div className="relative w-full aspect-video bg-gradient-to-br from-neutral-100 to-neutral-200 rounded-2xl border-2 flex items-center justify-center overflow-hidden">
          <Image
            src="/open-router-docs/xluspzcomvuwqi6tka67.webp"
      ...
      <section className="reveal flex flex-col gap-6 pt-24 max-w-3xl">
        ...
        <div className="relative w-full aspect-video bg-gradient-to-br from-neutral-100 to-neutral-200 rounded-2xl border-2 flex items-center justify-center overflow-hidden">
          <Image
            src="/open-router-docs/slyjtxv6dztvofhuvr7o.webp"
            alt="OpenRouter homepage"
            width={800}
            height={450}
            className="w-full h-full object-cover rounded-2xl"
      ...
      <section className="reveal flex flex-col gap-6 pt-24 max-w-3xl">
        ...
        <p className="text-xl leading-relaxed">
          ...
          then select <strong>&quot;Keys&quot;</strong> from the dropdown menu.
          Or go directly to{" "}
          <a
        ...
        <div className="relative w-full aspect-video bg-gradient-to-br from-neutral-100 to-neutral-200 rounded-2xl border-2 flex items-center justify-center overflow-hidden">
          <Image
            src="/open-router-docs/gxiclfdes103d6mzvfyj.webp"
            alt="OpenRouter homepage"
            width={800}
            height={450}
            className="w-full h-full object-cover rounded-2xl"
      ...
      <section className="reveal flex flex-col gap-6 pt-24 max-w-3xl">
        ...
        <p className="text-xl leading-relaxed">
          Click on the <strong>&quot;Create Key&quot;</strong> button. You can
          give your key a name like <em>&quot;Gomotion&quot;</em> to easily
          identify it later.
        </p>
        ...
        <div className="relative w-full aspect-video bg-gradient-to-br from-neutral-100 to-neutral-200 rounded-2xl border-2 flex items-center justify-center overflow-hidden">
          <Image
            src="/open-router-docs/qar2zqqmblxogljpu1fi.webp"
            alt="OpenRouter homepage"
            width={800}
            height={450}
            className="w-full h-full object-cover rounded-2xl"
      ...
      <section className="reveal flex flex-col gap-6 pt-24 max-w-3xl">
        ...
        <p className="text-xl leading-relaxed">
          Your new API key will be displayed. <strong>Important:</strong> Copy
          it immediately and store it somewhere safe. You won&apos;t be able to
          see the full key again after leaving this page.
        </p>
        ...
        <div className="relative w-full aspect-video bg-gradient-to-br from-neutral-100 to-neutral-200 rounded-2xl border-2 flex items-center justify-center overflow-hidden">
          <Image
            src="/open-router-docs/u6hmq18rfw8wcypntvnd.webp"
            alt="OpenRouter homepage"
            width={800}
            height={450}
            className="w-full h-full object-cover rounded-2xl"
      ...
      <section className="reveal flex flex-col gap-6 pt-24 max-w-3xl">
        ...
        <div className="relative w-full aspect-video bg-gradient-to-br from-neutral-100 to-neutral-200 rounded-2xl border-2 flex items-center justify-center overflow-hidden">
          <Image
            src="/open-router-docs/u9gegdrbbikphhhtdfrd.webp"
            alt="OpenRouter homepage"
            width={800}
            height={450}
            className="w-full h-full object-cover rounded-2xl"
      ...
      <section className="reveal flex flex-col gap-6 pt-24 max-w-3xl">
        ...
        <div className="relative w-full aspect-video bg-gradient-to-br from-neutral-100 to-neutral-200 rounded-2xl border-2 flex items-center justify-center overflow-hidden">
          <Image
            src="/open-router-docs/ygusvipez5hyhmgybi2u.webp"
            alt="OpenRouter homepage"
            width={800}
            height={450}
            className="w-full h-full object-cover rounded-2xl"
      ...
      <section className="reveal flex flex-col gap-8 pt-24 pb-32 max-w-3xl">
        ...
        <div className="space-y-6 pt-8">
          <h3 className="text-2xl font-neue-montreal font-bold">Need Help?</h3>
