        ...
        <div className="flex-1">
          <div className="w-full sm:w-[70%] space-y-8 sm:space-y-16">
            ...
            <p className="leading-relaxed text-muted-foreground">
              You’ve seen what’s possible—now it’s your turn. Go from idea to
              motion in minutes with the power of prompt-based animation. No
              tools. No barriers. Just creativity in motion.
            </p>
            <Link href="/explore">
              <Button size="lg">
                Create animations <ArrowRight />{" "}
              </Button>
            </Link>
          </div>
        </div>
